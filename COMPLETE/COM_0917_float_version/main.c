...
#define describe(s) printf("****** "s" ******\n")
#define NL printf("\n")
#define PRINTF(params) { \
	int actual = ft_printf params; printf(" [%d]",actual); NL; \
	int expected =  printf params; printf(" [%d]",expected); NL; \
}
...
int main()
{
	...
	describe("%%s width, precisions and -");
	...
	describe("%%d widths, precisions and -");
	PRINTF(("%-d", 0));
	PRINTF(("%-d", 1));
	PRINTF(("%-d", 10));
	PRINTF(("%-d", -10));
	...
	describe("%%i widths, precisions and -");
	PRINTF(("%-i", 0));
	PRINTF(("%-i", 1));
	PRINTF(("%-i", 10));
	PRINTF(("%-i", -10));
	...
	describe("%%u widths, precisions and -");
	PRINTF(("%-u", 0));
	PRINTF(("%-u", 1));
	PRINTF(("%-u", 10));
	PRINTF(("%-u", -10));
	...
	describe("%%x widths, precisions and -");
	PRINTF(("%-x", 0));
	PRINTF(("%-x", 1));
	PRINTF(("%-x", 10));
	PRINTF(("%-x", -10));
	...
	describe("%%d, widths, precisions and 0");
	PRINTF(("%01d", 0));
	PRINTF(("%01d", -4));
	PRINTF(("%010d", 42));
	PRINTF(("%042d", 42000));
	...
	describe("%%i, widths, precisions and 0");
	PRINTF(("%01i", 0));
	PRINTF(("%01i", -4));
	PRINTF(("%010i", 42));
	PRINTF(("%042i", 42000));
	...
	describe("%%u, widths, precisions and 0");
	PRINTF(("%01u", 0));
	PRINTF(("%01u", -4));
	PRINTF(("%010u", 42));
	PRINTF(("%042u", 42000));
	...
	describe("%%x, widths, precisions and 0");
	PRINTF(("%01x", 0));
	PRINTF(("%01x", -4));
	PRINTF(("%010x", 42));
	PRINTF(("%042x", 42000));
	...
	PRINTF(("%0214d", 110));
	PRINTF(("%0214.12d", 110));
	PRINTF(("%0214x", INT_MIN));
	PRINTF(("%02.140x", INT_MIN));
	PRINTF(("%#0214x", 11111111));
	PRINTF(("%#2142x", 11111111));
	PRINTF(("%x%tt05%r%q%w%q%m", 11111111));
	PRINTF(("%x%05tt%r%q%w%q%m", 11111111));
	PRINTF(("%x%tt05", 11111111));
	PRINTF(("%x%tt 05%", 11111111));
	PRINTF(("%x%tt0*%", 11111111, 5));
	PRINTF(("%x%tt05", 11111111));
	PRINTF(("%-+d", 0));
	PRINTF(("%-+d", 1));
	PRINTF(("%-+d", -1));
	...
	ptrdiff_t d = 100;
	size_t sz = 42;
	PRINTF(("%jd%td%zd", w, d, sz));
	PRINTF(("%-jd%-td%-zd", w, d, sz));
	PRINTF(("% jd% td% zd", w, d, sz));
	PRINTF(("%06.10jd%06.10td%06.10zd", w, d, sz));

	int np;
	long nlp;
	long long nllp;
	PRINTF(("123%n456%ln789%lln", &np, &nlp, &nllp));
	PRINTF(("%d%ld%lld", np, nlp, nllp));
#else
	PRINTF(("%c%c%c*", '\0', '1', 1));
